...
train_recipe <- recipe(chickenpox ~ ., data = train_data) |>
  step_downsample(chickenpox) # Possible but we want to create a screening model, so it is best to have a slight imbalance towards the positive class, step_downsample is from the package themis
